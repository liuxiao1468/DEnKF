...
class BayesianImageSensorModel(nn.Module):
    '''
    ...
    input -> [batch_size, channel, img_w, img_h]
    output ->  [batch_size, num_ensemble, dim_z]
    '''
    def __init__(self, num_ensemble, dim_z):
        ...
        self.fc3 = LinearFlipout(64, 32)
        self.fc4 = LinearFlipout(32, self.dim_z)
...
class ObservationNoise(nn.Module):
    def __init__(self, dim_z, r_diag):
        ...
        self.fc2 = nn.Linear(64, self.dim_z)
...
class Ensemble_KF(nn.Module):
    def __init__(self, num_ensemble, dim_x, dim_z):
        super(Ensemble_KF, self).__init__()
        self.num_ensemble = num_ensemble
        self.dim_x = dim_x
        self.dim_z = dim_z
        ...
        self.sensor_model = BayesianImageSensorModel(self.num_ensemble, self.dim_z)
